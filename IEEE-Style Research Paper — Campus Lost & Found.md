...
# APPENDIX B — IMPORTANT TERMINOLOGY FOR THE FINAL PAPER

The following terminology should be used consistently:

**Use:** “deterministic matching engine”

**Avoid:** “AI-powered matching” unless the implementation is subsequently changed to use an AI/ML model.

**Use:** “match score”

**Avoid:** “matching accuracy” when referring to the numerical score.

**Use:** “ownership verification”

**Avoid:** “automatic ownership confirmation.”

**Use:** “implemented functionality”

**Avoid:** “proven effectiveness” unless supported by experimental evidence.

**Use:** “expected benefit”

**Avoid:** “measured improvement” without empirical measurements.

**Use:** “software-level testing”

**Avoid:** “real-world validation” unless users and real-world data have been studied.