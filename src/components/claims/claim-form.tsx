    ...
    <FadeUp delay={0.1}>
      <form action={formAction} className="space-y-6">
        <div className="space-y-3">
          ...
          <p className="text-small text-muted-foreground measure-default">
          ...
          />
          <p className="text-caption text-muted-foreground">20–500 characters.</p>
        </div>

        <div className="flex items-start gap-3 rounded-2xl border border-border/40 bg-secondary/30 px-5 py-4">
